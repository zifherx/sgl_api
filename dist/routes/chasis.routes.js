...
router.post('/', [_middlewares.authJwt.verifyToken, _middlewares.authJwt.isAdmin, _middlewares.verifyDuplicate.checkDuplicateChasis], chasisCtrl.createChasis); //Actualizar Chasis
