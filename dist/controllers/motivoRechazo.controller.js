        ...
        switch (_context.prev = _context.next) {
          ...
          case 8:
            return _context.abrupt("return", res.status(404).json({
              message: "No existen motivos de rechazo"
            }));
        ...
        switch (_context2.prev = _context2.next) {
          ...
          case 9:
            return _context2.abrupt("return", res.status(404).json({
              message: "No existe motivo de rechazo"
            }));
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 8:
            return _context3.abrupt("return", res.status(404).json({
              message: "No existen motivos de rechazo activos"
            }));
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 9:
            ...
            if (query) {
              res.json({
                message: "Motivo de rechazo creado con éxito"
              });
            }
...
rechazoController.updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var _req$body2, name, status, motivoId, query;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 5:
            ...
            res.json({
              message: "Motivo de rechazo actualizado con éxito"
            });
            _context5.next = 11;
            break;
          ...
          case 10:
            return _context5.abrupt("return", res.status(404).json({
              message: "No existe motivo de rechazo a actualizar"
            }));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            res.json({
              message: "Motivo de rechazo eliminado con éxito"
            });
            _context6.next = 10;
            break;
          ...
          case 9:
            return _context6.abrupt("return", res.status(404).json({
              message: "No existe motivo de rechazo a eliminar"
            }));
...
//# sourceMappingURL=motivoRechazo.controller.js.map