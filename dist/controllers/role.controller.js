      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.prev = 1;
            _context2.next = 4;
            return _Role["default"].findById(roleId).sort({
              name: 'asc'
            });
...
roleCtrl.getCount = /*#__PURE__*/function () {
...
roleCtrl.createRole = /*#__PURE__*/function () {
  var _ref4 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(req, res) {
    var _req$body, name, description, status, userCreator, newRole, userFound, query;

    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _req$body = req.body, name = _req$body.name, description = _req$body.description, status = _req$body.status, userCreator = _req$body.userCreator;
            _context4.prev = 1;
          ...
          case 5:
            ...
            newRole.userCreator = userFound.map(function (a) {
              return a._id;
            });
            _context4.next = 9;
            return newRole.save();
