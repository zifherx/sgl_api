...
conversionCtrl.getAll = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _EstadoConversion["default"].find().populate({
              path: 'createdBy',
...
conversionCtrl.getActivos = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return _EstadoConversion["default"].find({
              status: true
            }).populate({
              path: 'createdBy',
              select: 'name username'
...
conversionCtrl.getOneById = /*#__PURE__*/function () {
  var _ref3 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee3(req, res) {
    var conversionId, query;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.prev = 1;
            _context3.next = 4;
            return _EstadoConversion["default"].findById(conversionId).populate({
              path: 'createdBy',
              select: 'name username'
            });
...
conversionCtrl.createOne = /*#__PURE__*/function () {
    ...
    return _regenerator["default"].wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 7:
            newObj = new _EstadoConversion["default"]({
              name: name,
              value: value,
              status: status
            });
...
conversionCtrl.updateOneById = /*#__PURE__*/function () {
  var _ref5 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5(req, res) {
    var conversionId, _req$body2, name, value, status, query;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.prev = 2;
            _context5.next = 5;
            return _EstadoConversion["default"].findByIdAndUpdate(conversionId, {
              name: name,
              value: value,
              status: status
            });
...
conversionCtrl.deleteOneById = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.prev = 1;
            _context6.next = 4;
            return _EstadoConversion["default"].findByIdAndDelete(conversionId);
